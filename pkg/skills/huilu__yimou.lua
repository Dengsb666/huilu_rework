...
Fk:loadTranslationTable{
  ["huilu__yimou"] = "毅谋",
  [":huilu__yimou"] = "当至你距离1以内的角色受到伤害后，你可以选择一项：1.令其从牌堆获得一张【杀】；2.令其将一张手牌交给另一名角色，摸一张牌。",

  ["huilu__yimou_slash"] = "%dest获得一张【杀】",
  ["huilu__yimou_give"] = "%dest将一张手牌交给另一名角色，摸一张牌",
  ["#huilu__yimou-give"] = "毅谋：将一张手牌交给一名其他角色，然后摸一张牌",

  ["$huilu__yimou1"] = "泰然若定，攻敌自溃！",
  ["$huilu__yimou2"] = "吾等当为大义，兴大谋，成大事！",
}
...
yimou:addEffect(fk.Damaged, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    local choices = { "huilu__yimou_slash::"..target.id }
    if not target:isKongcheng() and #room:getOtherPlayers(target, false) > 0 then
      table.insert(choices, "huilu__yimou_give::"..target.id)
    end
  ...
  on_use = function(self, event, target, player, data)
    ...
    if choice:startsWith("huilu__yimou_slash") then
